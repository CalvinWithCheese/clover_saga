...
function buildToc() {
  ...
  document.querySelectorAll('.era').forEach((era) => {
    ...
    eraHeader.append(eraToggle, eraLink);
    ...
    eraLi.append(eraHeader, segmentsList);
...
function renderSegment(segment, eraLabel, segmentIndex, options = {}) {
  ...
  if (options.additionalClass) article.classList.add(options.additionalClass);
  ...
  if (options.headerClass) headerButton.classList.add(options.headerClass);
